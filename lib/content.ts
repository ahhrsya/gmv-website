...
export const content = {
  ...
  sederhana: {
    en: {
      ...
      stats: [
        { number: '200+', label: 'Locations in Indonesia & Malaysia' },
        { number: '28.4M', label: 'Annual customers at peak (2017–18)' },
        { number: '54', label: 'Years of continuous operation' },
        { number: '#1', label: 'Indonesian culinary icon' },
      ],
    ...
    id: {
      ...
      stats: [
        { number: '200+', label: 'Lokasi di Indonesia & Malaysia' },
        { number: '28,4JT', label: 'Pelanggan tahunan pada puncaknya (2017–18)' },
        { number: '54', label: 'Tahun operasi berkelanjutan' },
        { number: '#1', label: 'Ikon kuliner Indonesia' },
      ],
  ...
  contact: {
    en: {
      ...
      p2: 'We are building a global platform for Minang cuisine and we are looking for the right partners to grow it together.',
    ...
    id: {
      ...
      p2: 'Kami membangun platform global untuk kuliner Minang dan kami mencari mitra yang tepat untuk mengembangkannya bersama.',
